        ...
        while (isStart) {
            ...
            if (NetManager.instance().isNetworkConnected()) {
                ...
                if (!TCPClient.instance().isConnect()) {
                    logger.e(tag, "TCPClient connet server is fail read thread sleep second" + Const.SOCKET_SLEEP_SECOND);
                ...
                logger.e("socket", "TCPClient.instance().isConnect() " + TCPClient.instance().isConnect());
