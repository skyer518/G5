...
import cn.com.lightech.led_g5g.presenter.ControlCurvePresenter;
import cn.com.lightech.led_g5g.view.AppBaseFragment;
import cn.com.lightech.led_g5g.view.console.IAutoView;
import cn.com.lightech.led_g5g.wedgit.MyMarkerView;
...
public class AutoFragment extends AppBaseFragment implements OnChartValueSelectedListener, IAutoView {
    ...
    private ControlCurvePresenter autoPresenter;
    ...
    public static AutoFragment newInstance(byte param1, byte param2) {
        AutoFragment fragment = new AutoFragment();
        Bundle args = new Bundle();
        args.putByte(ARG_PARAM1, param1);
        args.putByte(ARG_PARAM2, param2);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            dataId = getArguments().getByte(ARG_PARAM1);
            timingid = getArguments().getByte(ARG_PARAM2);
        }
    }
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        this.autoPresenter = new ControlCurvePresenter(getActivity(), this, dataId, timingid);
        return rootView;
    }
...
//        leftAxis.setDrawGridLines(false);
    ...
    public void drawChart() {
        List<CurvePoint> points = CurveData.genData4PreviewChart(DataManager.getInstance().getCurveDataById2(dataId));
