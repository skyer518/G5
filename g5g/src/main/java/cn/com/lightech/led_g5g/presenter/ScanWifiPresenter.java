...
public class ScanWifiPresenter {
    ...
    private static final int WHAT_SHOW_ERROR = 0x00;
    private static final int WHAT_GOTO_NEXT = 0x01;
    private static final int WHAT_WIFI_CONNECTED = 0x02;
    private static final int WHAT_LED_CONNECTED = 0x03;
    private static final int WHAT_LED_FAILED = 0x04;
    private static final int WHAT_WIFI_FAILED = 0x05;
    private static final int WHAT_SET_FLAG_SUCCESS = 0x06;
    private static final int WHAT_SET_FLAG_FAILED = 0x07;
    private static final int WHAT_SET_WIFI_SUCCESS = 0x08;
    private static final int WHAT_ON_GET_MAC_ADDRESS_SUCCESS = 0x09;
    private static final int WHAT_ON_GET_MAC_ADDRESS_FAILED = 0x0a;

    private final Context mContext;
    private final IWifiView wifiView;
    private final ScanResult ledWifi;
    private WifiManager wifiManager;
    private ScanResult lanWifi;
    private String lanWifiPwd;
    private byte[] mac;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WHAT_SET_WIFI_SUCCESS:
                    reboot2Led();
                    break;
                case WHAT_ON_GET_MAC_ADDRESS_SUCCESS:
                    saveData2LED();
                    break;
            }
        }
            ...
            protected void onPostExecute(String s) {
                ...
                */
                ...
                if (matcher.find()) {
                    ...
                    handler.sendEmptyMessage(WHAT_ON_GET_MAC_ADDRESS_SUCCESS);
                } else {
                    handler.sendEmptyMessage(WHAT_ON_GET_MAC_ADDRESS_FAILED);
                }
            }
...
//                handler.sendEmptyMessage(WHAT_SET_WIFI_SUCCESS);
                handler.sendEmptyMessage(WHAT_GOTO_NEXT);
            }
    ...
    class TcpTask implements IDataListener {
        ...
        void over(boolean successs) {
            ProgressUtil.closeDialog();
            if (successs) {
                handler.sendEmptyMessage(WHAT_SET_FLAG_SUCCESS);
            } else {
                handler.sendEmptyMessage(WHAT_SET_FLAG_FAILED);
            }
