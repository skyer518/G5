...
public abstract class MarkerView extends RelativeLayout {
     ...
     */
    public abstract void refreshContent(List<Entry> entries, Highlight highlight);

    public abstract void refreshContent(List<Entry> e, Highlight highlight, String xLable);
