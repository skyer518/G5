...
//    @Bind(cn.com.u2be.led_g5w.R.id.tv_info)
//    TextView tvInfo;
//    @Bind(cn.com.u2be.led_g5w.R.id.btn_groupBroadcast)
//    Button btnGroupBroadcast;
//    @Bind(cn.com.u2be.led_g5w.R.id.btn_singleBroadcast)
//    Button btnSingleBroadcast;
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(cn.com.u2be.led_g5w.R.layout.activity_main);
