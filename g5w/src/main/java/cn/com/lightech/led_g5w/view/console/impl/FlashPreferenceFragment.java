...
//        bindPreferenceIntValue(findPreference(getString(R.string.pref_key_flash_time3_start)));
    ...
    public FlashDataNode getData() {
        ...
        flashDataNode.setTime1(new TimeBucket(flashTime1Start, flashTime1End));
        flashDataNode.setTime2(new TimeBucket(flashTime2Start, flashTime2End));
        flashDataNode.setTime3(new TimeBucket(flashTime3Start, flashTime3End));
