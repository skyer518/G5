...
import cn.com.lightech.led_g5w.view.console.impl.BasePreferenceFragment;
...
public class SprayPreferenceFragment extends BasePreferenceFragment {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.pref_spray);
